...
public enum Resource {;
    ...
    public enum InterfaceAsset {
        ...
        ICON_CREATE_NEW(Folder.INTERFACE.getPath() + "create_new_alt.png"),
        ...
        GLYPH_CREATE_NEW_SET(Folder.INTERFACE.getPath() + "create_new_set.png"),
        GLYPH_SAVE_CLASS(Folder.INTERFACE.getPath() + "save_class1.png"),
        GLYPH_SAVE_CLASS_PRESSED(Folder.INTERFACE.getPath() + "save_class2.png"),
